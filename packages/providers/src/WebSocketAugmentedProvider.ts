...
import { BlockWithTransactions } from "@ethersproject/providers/node_modules/@ethersproject/abstract-provider";
...
export const isWebSocketAugmentedProvider = (provider: Provider) =>
...
export class WebSocketAugmentedWeb3Provider
  ...
  implements WebSocketAugmentedProvider
{
  ...
  async call(transaction: Deferrable<TransactionRequest>, blockTag?: BlockTag | Promise<BlockTag>) {
...
webSocketAugmentedProviders.push(WebSocketAugmentedWeb3Provider);
