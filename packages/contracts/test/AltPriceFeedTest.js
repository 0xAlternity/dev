const PriceFeed = artifacts.require("./AltPriceFeedTester.sol");
const PriceFeedTestnet = artifacts.require("./PriceFeedTestnet.sol");
const MockChainlink = artifacts.require("./MockAggregator.sol");
const MockTellor = artifacts.require("./AltMockTellor.sol");
...
const CNYUSD_TELLOR_REQ_ID = 999;
const ethPrice = dec(3000, 18);
const cnyPrice = dec(100, 18);

contract("AltPriceFeed", async accounts => {
  ...
  describe("AltPriceFeed internal testing contract", async accounts => {
  ...
  describe("Mainnet AltPriceFeed setup", async accounts => {
  ...
  it("C1 Chainlink working: fetchPrice should return the correct price, taking into account the number of decimal digits on the aggregator", async () => {
    ...
    // Check AltPriceFeed gives 10, with 18 digit precision
    ...
    //Check AltPriceFeed gives 1, with 18 digit precision
