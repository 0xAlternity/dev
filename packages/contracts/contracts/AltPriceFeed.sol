 ...
 * Chainlink oracle.
 */
contract AltPriceFeed is Ownable, CheckContract, BaseMath, IPriceFeed {
    using SafeMath for uint256;

    string public constant NAME = "AltPriceFeed";
    ...
    function _chainlinkIsFrozen(ChainlinkResponse memory _response) internal view returns (bool) {
        return
            ...
            block.timestamp.sub(_response.cnyTimestamp) > TIMEOUT;
    }
    ...
    function _tellorIsFrozen(TellorResponse memory _tellorResponse) internal view returns (bool) {
        return
            ...
            block.timestamp.sub(_tellorResponse.cnyTimestamp) > TIMEOUT;
    }
